...
export const realEstateCards = [
  {
    ...
    label: "Browse & Select",
    subtext:
      "Browse Raveum properties, each pre-vetted for their investment potential",
  },
  {
    number: 2,
    label: "Buy Shares",
    subtext:
      "Choose investment amount, select shares, sign terms electronically, and fund",
  },
  {
    number: 3,
    label: "Relax & Earn",
    subtext:
      "Earn Rental Income & Appreciation, all while Raveum manages the properties",
  },
];
